...
<div class="page-header page-header-light">
  <div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
      <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">John Doe <?=$id?></span></h4>
    </div>
  </div>
  ...
  <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
    <div class="d-flex">
      <div class="breadcrumb">
        ...
        <a href="#" class="breadcrumb-item active">John Doe <?=$id?></a>
      </div>
    ...
    <div class="card-body">
      ...
      <input type="hidden" name="token" value="<?=$_SESSION['token']?>">
          <div class="form-group row">
            ...
            <div class="col-lg-10">
              <input type="text" class="form-control" name="name" value="John Doe <?=$id?>" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-10">
              <input type="email" class="form-control" name="email" value="JohnDoe<?=$id?>@gmail.com" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-10">
              <input type="text" class="form-control" name="address" value="John Doe <?=$id?>" required>
            </div>
          </div>
