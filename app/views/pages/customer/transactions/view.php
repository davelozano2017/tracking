  ...
  <div class="card">
    <div class="card-body">
      <form action="<?=site_url('Transactions/UpdateTransactions')?>" method="POST" data-parsley-validate>
          <input type="hidden" name="service_mode_id" value="<?=encode($value[0]['ServiceModeId'])?>">
          <input type="hidden" class="form-control" name="transactions_id" value="<?=encode($value[0]['transactions_id'])?>" required>
          <input type="hidden" class="form-control" name="pay_mode_id" readonly value="<?=encode($value[0]['PayModeId'])?>" >
          <input type="hidden" class="form-control" name="origin_id" readonly value="<?=encode($value[0]['OriginId'])?>" >
        <div class="form-group row">
          <label class="col-form-label col-lg-2">AWB #:</label>
          <div class="col-lg-10">
          <input type="number" class="form-control" readonly  name="awb_number" value="<?=$value[0]['awbNumber']?>" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <select name="shipper_id"readonly  class="form-control">
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <select name="consignee_id" readonly  class="form-control">
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
               <input type="text" class="form-control" value="<?=$value[0]['Origin']?>" readonly>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="text" class="form-control" readonly value="<?=$value[0]['Address']?>" name="address">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="number" class="form-control" readonly name="quantity" value="<?=$value[0]['Quantity']?>"  required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="text" class="form-control" readonly name="description" value="<?=$value[0]['Description']?>"  required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="text" class="form-control" readonly name="cwt" value="<?=$value[0]['Cwt']?>"  required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="text"  class="form-control" readonly value="<?=$value[0]['PayModeName']?>" >
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
          <input type="text" class="form-control" readonly value="<?=$value[0]['ServiceModeName']?>" >
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="text" class="form-control" readonly  name="amount" value="<?=$value[0]['Amount']?>" required>
          </div>
        </div>
